...
public class ExtentITestNGListeners  implements ITestListener {
	...
	public void onTestSuccess(ITestResult result) {
		...
		String path =ScreenshotUtil.getScreenshot(BaseTest.driver, result.getMethod().getMethodName());
		
		//parentTest.get().pass("Test Passed");
		
	    parentTest.get().log(Status.PASS,result.getName()+"Got Successfully Pass!").addScreenCaptureFromPath(path);
