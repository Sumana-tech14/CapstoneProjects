...
public class ExtentITestNGListeners implements ITestListener {
	...
	{
		String path =ScreenshotUtils.getScreenshot(BaseTest.driver, result.getMethod().getMethodName());
		
		parentTest.get().fail("Test Failed "+result.getThrowable().getMessage()).addScreenCaptureFromPath(path);
